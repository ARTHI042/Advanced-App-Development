  ...
  return (
    ...
    <div className="about-me">
     ...
     <Link to='/Booking'> <button className='button-33'>BOOK NOW</button></Link></div>
      ...
      <p className='para'>Kerala houseboat package in Kashmir is the longest among the packages, as it will take you beyond Kashmir. <br></br>Location:Sonwar Bagh<br></br>Plan:4 NIGHTS / 5 DAYS<br></br>Cost:26,000/- </p>
