...
function Services() {
  return (
    ...
    <div className="about-me">
      ...
      <p className='para'>This is the best option for cruising through the heavenly backwaters of Maharashtra.<br></br>Location:Guhagar<br></br>Plan:2 NIGHTS / 3 DAYS<br></br>Cost:13,000/-</p>
     <Link to='/Booking'> <button className='button-33'>BOOK NOW</button></Link></div>
      ...
      <p className='para'>This is best for those who have ample time to spare.<br></br>You can bathe in the breathtaking beauty of the Kerala backwaters. <br></br>Location:Konkan<br></br>Plan:3 NIGHTS / 4 DAYS<br></br>Cost:19,000/-</p><br></br>
      ...
      <p className='para'>Maharashtra houseboat package in Tarkali is the longest among the packages, as it will take you beyond Tarkali.<br></br>You can bathe in the breathtaking beauty of the Maharashtra backwaters. <br></br>Location:Tharkali<br></br>Plan:4 NIGHTS / 5 DAYS<br></br>Cost:26,000/- </p>
       <Link to='/Booking'><button className='button-33'>BOOK NOW</button></Link></div>
    </div>
